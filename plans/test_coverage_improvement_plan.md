...
- ✅ `MPGraphvizRenderingTests.m` - 17 tests for Graphviz diagram rendering, MutationObserver re-rendering on DOM replacement, script inclusion/exclusion (Issue #332)
